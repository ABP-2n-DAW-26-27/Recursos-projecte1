...
if(isset($_COOKIE["names"])){
    $names = json_decode($_COOKIE["names"], true);
    //print_r($names);
}
$message = "Hello World";
if(isset($_POST["userName"])){
    ...
    setcookie("names", $jsonNames, time() + 3600);
}
?>
<!DOCTYPE html>
<html lang="ca">
...
<body>
    ...
    <div class="container">
        <div class="left-panel">
            <form action="hello4.php" class="form-content"  method="POST">
                <h2>Benvingut!</h2>
            ...
            <div class="name-list-container">
                ...
                <!-- Work in progress -->
                <ul class="name-list">
                   <?php foreach($names as $name => $count) { ?>
                        <ul><?= $name ?> (<?= $count ?>)</ul>
                   <?php } ?>
                </ul>
                <!-- Work in progress -->
